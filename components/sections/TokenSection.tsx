    ...
    >
      <div className="section-container flex flex-col items-center justify-center mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-stretch w-full justify-center text-center justify-center">
          ...
          <div className="reveal opacity-0 translate-y-4 transition-all duration-700 [&.revealed]:opacity-100 [&.revealed]:translate-y-0 w-full h-full min-h-[400px] max-w-[95vw] sm:max-w-full flex flex-col justify-between">
