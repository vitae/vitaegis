...
export const routes: RunRoute[] = [
  {
    ...
    cues: [
      { mi: 0.0, text: 'Ewa (west) on Kalakaua from Kaimana Beach: the Natatorium, the Aquarium, the park on your right.' },
      ...
      { mi: 2.1, text: 'Back at the beach. Strides on the park grass, then finish barefoot on the sand.' },
    ],
