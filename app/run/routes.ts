...
export const routes: RunRoute[] = [
  {
    ...
    cues: [
      {
        mi: 0.0,
        text: 'Ewa (west) on Kalakaua from Kaimana Beach: the Natatorium, the Aquarium, the park on your right.',
      },
      {
        mi: 0.5,
        text: 'Right onto Kapahulu Ave for one block, then right onto Monsarrat Ave past the zoo.',
      },
      { mi: 1.0, text: 'Right onto Paki Ave along the mauka edge of the park, under the banyans.' },
      { mi: 1.7, text: 'Paki ends at Poni Moi Rd. Right, then right again onto Kalakaua.' },
      {
        mi: 2.1,
        text: 'Back at the beach. Strides on the park grass, then finish barefoot on the sand.',
      },
    ],
  ...
  },
  {
    ...
    marathonMiles:
      'Marathon miles 24.4–25.8 (Diamond Head Rd and Kahala Ave) run in reverse, then Kilauea Ave, which the race reaches at mile 9.7',
    plan: [
      {
    ...
    cues: [
      {
        mi: 0.0,
        text: 'West out of Kaimana Beach on Kalakaua, then right on Poni Moi Rd and left onto Diamond Head Rd. The climb starts at once.',
      },
      {
        mi: 0.7,
        text: 'Beach Rd drops away on your right. Stay on the ocean-side sidewalk past the Kuilei Cliffs lookouts.',
      },
      {
        mi: 1.3,
        text: 'Lighthouse and the surf lookouts, then a gentle descent along the cliffs.',
      },
      {
        mi: 1.8,
        text: 'Kahala Ave junction: Diamond Head Rd bends left and uphill; you keep straight along the coast on Kahala Ave.',
      },
      ...
      {
        mi: 4.0,
        text: 'Kahala Mall at the Kilauea / Waialae corner. Planet Fitness and Whole Foods are 100 m in, on the Ewa end.',
      },
    ],
    ...
    facts: [
      {
        label: 'Faster variant',
        value:
          'Go the back way over the crater instead: Paki, Monsarrat, around the mauka side past the KCC lot, then Kilauea Ave all the way down. About 4 miles with one real climb on Monsarrat.',
      },
    ],
  },
  {
    ...
    plan: [
      {
        title: 'Market',
        body: 'KCC Farmers Market · 4303 Diamond Head Rd, parking lot C across from the crater entrance · Saturdays 7:30–11 am · run by the Hawaii Farm Bureau. Arrive at opening; by 9 the lines are long.',
      },
      {
        title: 'Carry',
        body: 'A light running vest handles coffee-and-pastry loads. For a real grocery run take Route 2 from the market to Kapahulu Ave (frequent, 24 hours) and walk the last mile, or run the loop reversed so the market is at mile 2.7.',
      },
    ],
    cues: [
      {
        mi: 0.0,
        text: 'East on Kalakaua from Kaimana Beach, then bear left onto Paki Ave at Poni Moi Rd.',
      },
      ...
      {
        mi: 1.7,
        text: 'KCC Farmers Market, lot C on your right. Coffee, Dakota corn, fried green tomatoes, mochi.',
      },
      {
        mi: 2.0,
        text: 'Continue on Diamond Head Rd around the east side: Fort Ruger Park, then it swings right and descends.',
      },
  ...
  },
  {
    ...
    tagline:
      'Out to the lighthouse, on through Kahala, and back over Kaimuki: seven miles, two climbs.',
    color: '#00e5ff',
    ...
    marathonMiles:
      'Marathon miles 24.4–25.8 (Kahala Ave and Diamond Head Rd) run in reverse, Kilauea Ave in reverse, then Monsarrat downhill',
    cues: [
      {
        mi: 0.0,
        text: 'East from Kaimana Beach on Kalakaua; right on Poni Moi Rd, then left onto Diamond Head Rd. The climb starts at once.',
      },
      {
        mi: 0.7,
        text: 'Beach Rd drops away on your right. Stay on the ocean-side sidewalk past the Kuilei Cliffs lookouts.',
      ...
      {
        mi: 1.3,
        text: 'Lighthouse and the surf lookouts, then a gentle descent along the cliffs with Black Point ahead.',
      },
      {
        mi: 1.8,
        text: 'Kahala Ave junction: Diamond Head Rd bends left and uphill; you keep straight along the coast on Kahala Ave.',
      ...
      {
        mi: 2.4,
        text: 'Flat and shaded through the Kahala mansions. Waialae Beach Park has water and restrooms.',
      },
      {
        mi: 3.3,
        text: 'Left onto Pueo St just past the beach park; half a mile through the neighborhood to Kilauea Ave.',
      },
      {
        mi: 3.8,
        text: 'Left onto Kilauea Ave. Kahala Mall is a quarter mile the other way if you need anything.',
      },
      { mi: 4.3, text: 'Cross 22nd Ave; Kilauea starts climbing through Kaimuki.' },
      {
        mi: 4.9,
        text: 'Crest at Makapuu Ave, the high point. Left onto Makapuu and drop to Diamond Head Rd.',
      },
      {
        mi: 5.5,
        text: 'Right onto Diamond Head Rd, then it becomes Monsarrat: a mile down past the food trucks and the zoo.',
      },
      {
        mi: 6.5,
        text: 'Left onto Kalakaua at the Kapahulu corner and along the beach back to Kaimana.',
      },
    ],
    mapsUrl: walk([
      home,
    ...
    facts: [
      {
        label: 'Water',
        value:
          'Waialae Beach Park at mile 3 and Kapiolani Park at mile 6.5. Nothing on Diamond Head Rd or Kilauea Ave.',
      },
      {
        label: 'Two climbs',
        value:
          'Diamond Head Rd to the lighthouse, about 110 ft, and Kilauea Ave from 22nd Ave to Makapuu, about 200 ft. Everything from mile 4.7 is downhill or flat.',
      },
      {
        label: 'Shorter',
        value:
          'Turn up Elepaio St instead of Pueo for about 6 miles, or finish down Paki instead of along the beach for about 6.7.',
      },
    ],
  },
  {
    ...
    marathonMiles:
      'Marathon miles 4.9–8.7 in order, then the finish-side descent of miles 24.4–25.8',
    cues: [
      {
        mi: 0.0,
        text: 'Ewa (west) from Kaimana Beach on Kalakaua: the Natatorium, the Aquarium, Kapiolani Park on your left.',
      },
      {
        mi: 0.6,
        text: 'Cross Kapahulu Ave and stay on Kalakaua through Waikiki: Kuhio Beach, the Duke statue, the Royal Hawaiian.',
      },
      {
        mi: 1.7,
        text: 'Kalakaua ends; continue on Ala Moana Blvd over the Ala Wai bridge, Hilton lagoon then Ala Moana Center on your right.',
      },
      {
        mi: 2.4,
        text: 'Left into Ala Moana Regional Park. Follow the beach path west to the far end.',
      },
      {
        mi: 3.0,
        text: 'Loop Magic Island: out the harbor side, around the lagoon at the tip, back along the beach.',
      },
      { mi: 4.2, text: 'Leave the park and retrace Ala Moana Blvd and Kalakaua through Waikiki.' },
      {
        mi: 6.0,
        text: 'At Kapahulu Ave bear left onto Monsarrat Ave: the marathon mile-7 hill, one mile up past the zoo and the food trucks.',
      },
      {
        mi: 6.5,
        text: 'Monsarrat becomes Diamond Head Rd. Around the back of the crater: monument entrance, KCC, Fort Ruger Park, then it swings right and drops.',
      },
    ...
    facts: [
      {
        label: 'Water',
        value:
          'Fountains and restrooms at Kapiolani Park, Kuhio Beach, Ala Moana Beach Park and Magic Island; nothing on Diamond Head Rd after KCC.',
      },
      {
        label: 'Shorter',
        value:
          'Skip the Magic Island loop and turn at the park entrance for about 8 miles. Skip Ala Moana entirely and turn at the Ala Wai bridge for about 7.',
      },
    ],
  },
  {
    ...
    cues: [
      {
        mi: 0.0,
        text: 'Start on Ala Moana Blvd fronting Ala Moana Beach Park; run Ewa (west) toward downtown.',
      },
      {
        mi: 1.8,
        text: 'Past Aloha Tower the boulevard is Nimitz Hwy; right onto Nuuanu Ave into Chinatown.',
      },
      {
        mi: 1.9,
        text: 'Right onto S King St: Iolani Palace, the Kamehameha statue at 2.25, Honolulu Hale lights.',
      },
      { mi: 2.5, text: 'Fork right onto Kapiolani Blvd at South St.' },
      { mi: 3.5, text: 'Right onto Piikoi St.' },
      {
        mi: 3.8,
        text: 'Left onto Ala Moana Blvd past Ala Moana Center and over the Ala Wai bridge.',
      },
      ...
      {
        mi: 7.5,
        text: 'Paki runs into Diamond Head Rd: the first climb, 90 feet in half a mile, up to the lighthouse lookout.',
      },
      {
        mi: 8.7,
        text: 'Stay left on Diamond Head Rd at the Kahala Ave junction; right onto 18th Ave (9.4); right onto Kilauea Ave (9.7).',
      },
      {
        mi: 11.0,
        text: 'Kilauea feeds onto Kalanianaole Hwy at Kahala Mall. Long straight out through Aina Haina, Niu and Kuliouou.',
      },
      { mi: 15.2, text: 'Left onto Hawaii Kai Dr around the marina.' },
      {
        mi: 17.0,
        text: 'Right onto Keahole St; turnaround at Hawaii Kai Towne Center, mile 17.4.',
      },
    ...
    facts: [
      {
        label: 'Race day',
        value: 'Sunday, December 13, 2026 · 5:00 am start · no time limit · honolulumarathon.org',
      },
      {
        label: 'Getting to the start',
        value:
          'From Kaimana Beach it is 3.2 miles to the start on Ala Moana Blvd. Race-morning shuttles run from Waikiki; walking Kalakaua at 3:30 am with everyone else is the tradition.',
      },
      {
        label: 'Train on it',
        value:
          'The Ten covers miles 4.9–8.7 and the finish descent. The Kahala Errand is Monsarrat and Kilauea. For the Hawaii Kai out-and-back, take Route 23 to Kahala Mall and run Kalanianaole early on a Sunday when the shoulder is quiet.',
      },
    ],
  },
];
