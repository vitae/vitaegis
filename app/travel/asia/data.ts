...
const circuit: Leg[] = [
  ...
  },
  {
    ...
    to: 'DPS',
    farePP: 100,
    time: '~4h nonstop · one stop often cheaper',
  ...
  },
  {
    ...
    to: 'ICN',
    farePP: 140,
    time: '~7h nonstop · one stop cheaper',
...
export const rejected: Rejected & { farePP: number; viaSeoulPP: number } = {
  from: 'DPS',
  to: 'HNL',
  farePP: 450,
  viaSeoulPP: 400,
...
export const stops: Stop[] = [
  {
    ...
    transfer:
      'Narita: Keisei Skyliner to Ueno, ~41 min, about ¥2,600. Haneda: Keikyu line or monorail, ~20–30 min, under ¥700.',
    money:
      'Yen. Load a Suica or PASMO into Apple Wallet before you land — it pays for trains, konbini and vending machines.',
    dailyForTwo: '$170–240',
    doThis: [
    ...
    eatThis:
      'Standing soba, depachika basement food halls near closing time when the discount stickers come out, and one proper sushi counter lunch — lunch sets run a third of dinner.',
    watchOut:
      'Cherry blossom (late March – early April) and Golden Week (late April – early May) double hotel prices.',
  },
  {
    slug: 'shanghai',
    code: 'PVG',
    ...
    nights: '4 nights',
    entry:
      '240-hour visa-free transit. Arrive from Japan, leave to Thailand — a third country, not back where you came from — with the confirmed onward ticket in hand. Ask for the transit permit at the dedicated immigration lane.',
    transfer:
      'Pudong: the Maglev to Longyang Road, 8 minutes at up to 300 km/h, ¥50, then Metro Line 2. Or Line 2 all the way, ~70 min.',
    money:
      'Yuan, and nearly cashless. Set up Alipay or WeChat Pay with your US card before you fly; both now accept foreign cards.',
    dailyForTwo: '$130–200',
    doThis: [
    ...
    eatThis:
      'Xiaolongbao and shengjianbao for breakfast, hairy crab if you land in autumn, and scallion oil noodles anywhere with a queue.',
    watchOut:
      'Google, Instagram and WhatsApp are blocked. Buy a travel eSIM that roams outside the firewall before arrival. Avoid October 1–7, the Golden Week holiday.',
  },
  {
    slug: 'bangkok',
    code: 'BKK',
    ...
    nights: '5 nights',
    entry:
      'Visa-free, 30 days — cut from 60 on September 15, 2026. One 30-day extension is available at immigration for about 1,900 THB. The TDAC digital arrival card is mandatory, filed within three days before arrival.',
    transfer:
      'Suvarnabhumi: Airport Rail Link to Phaya Thai, 26 min, 45 THB, then BTS. Metered taxi to Sukhumvit about 350–450 THB with tolls.',
    money:
      'Baht. Cash for street food and markets; ATMs charge foreign cards ~220 THB a pull, so withdraw big.',
    dailyForTwo: '$90–150',
    doThis: [
    ...
    eatThis:
      'Boat noodles at Victory Monument, khao man gai, som tam with grilled chicken, mango sticky rice in season (March–June).',
    watchOut:
      'Temple dress code is enforced: shoulders and knees covered. Songkran (April 13–15) is a city-wide water fight — glorious or unbearable, plan accordingly.',
  },
  {
    slug: 'hanoi',
    code: 'HAN',
    ...
    nights: '4 nights',
    entry:
      'E-visa required before you fly: official portal only, ~$25 single entry, up to 90 days. Allow two weeks. Print it; list Noi Bai as entry and Tan Son Nhat as exit.',
    ...
    eatThis:
      'Bun cha for lunch, pho bo for breakfast, banh mi any time, egg coffee at a cafe that has been making it since the 1940s.',
    watchOut:
      'December–February is genuinely cold and grey in the north. Pack a layer. Crossing the street: walk slowly and steadily, never stop, never run.',
  },
  {
    slug: 'saigon',
    code: 'SGN',
    ...
    transfer:
      'Tan Son Nhat sits 7 km from District 1. Grab car ~150,000 VND; bus 109 for 15,000 VND.',
    ...
    watchOut:
      'May–October is the wet season: a hard downpour most afternoons, then clear. Phone-snatching from motorbikes is the one real street crime — keep it off the kerb side.',
  },
  {
    slug: 'bali',
    code: 'DPS',
    ...
    nights: '7 nights',
    entry:
      'Visa on arrival: IDR 500,000 (~$32), 30 days, extendable once. Buy the e-VOA online ahead, file the All Indonesia arrival declaration, and pay the IDR 150,000 Bali tourist levy.',
    transfer:
      'Ngurah Rai: Grab and Gojek pick up from the official lounge. Canggu or Seminyak 45–75 min, Ubud ~90 min, Uluwatu ~60 min. Traffic is the variable.',
    ...
    eatThis:
      'Nasi campur from a warung, babi guling, sate lilit, and whatever the smoothie-bowl economy is doing this year.',
    watchOut:
      'Nyepi, the day of silence in March, shuts the whole island including the airport for 24 hours. A scooter needs an international permit with a motorcycle endorsement, or your travel insurance will not pay.',
  },
  {
    slug: 'seoul',
    code: 'ICN',
    ...
    nights: '4 nights',
    entry:
      'Visa-free, 90 days. K-ETA is waived for US passports through December 31, 2026 — file the free e-Arrival card instead. Flying in 2027, check whether K-ETA (₩10,000) is back.',
    transfer:
      'Incheon: AREX express to Seoul Station, 43 min, about ₩11,000. All-stop train to Hongdae ~55 min for half that.',
    money:
      'Won. Cards everywhere; get a T-money or Climate Card for transit. Google Maps is weak here — use Naver Map or KakaoMap.',
    dailyForTwo: '$140–210',
    doThis: [
    ...
    eatThis:
      'Korean barbecue with soju, dakgalbi, convenience-store ramyeon by the Han River, and fried chicken with beer.',
    watchOut:
      'Chuseok and Lunar New Year empty the city and close half of it. July–August is monsoon-humid.',
  },
];
...
export const seasons: { label: string; months: number[]; why: string }[] = [
  {
    label: 'Tokyo',
    months: [1, 1, 2, 2, 2, 0, 0, 0, 1, 2, 2, 1],
    why: 'Spring bloom, autumn leaves. June rain, August steam.',
  },
  {
    label: 'Seoul',
    months: [0, 0, 1, 2, 2, 1, 0, 0, 2, 2, 1, 0],
    why: 'Spring and fall are short and perfect. Winter is hard cold.',
  },
  {
    label: 'Shanghai',
    months: [0, 1, 2, 2, 2, 0, 0, 0, 1, 2, 2, 1],
    why: 'Mild shoulders. Plum rains in June, typhoon edge in late summer.',
  },
  {
    label: 'Bangkok',
    months: [2, 2, 1, 0, 0, 0, 0, 0, 0, 1, 2, 2],
    why: 'Cool-dry November–February. April is the furnace.',
  },
  {
    label: 'Hanoi',
    months: [0, 0, 1, 2, 1, 0, 0, 0, 1, 2, 2, 1],
    why: 'October–November is the sweet spot. Winter drizzle, summer storms.',
  },
  {
    label: 'Saigon',
    months: [2, 2, 2, 1, 0, 0, 0, 0, 0, 0, 1, 2],
    why: 'Dry December–April. Afternoon downpours otherwise.',
  },
  {
    label: 'Bali',
    months: [0, 0, 0, 1, 2, 2, 2, 2, 2, 1, 0, 0],
    why: 'Dry May–September. The wet season is warm rain, not ruin.',
  },
];
...
export const paperwork: {
  ...
  {
    country: 'Japan',
    status: 'Visa-free · 90 days',
    cost: '$0',
    file: 'Visit Japan Web (optional, faster)',
    ahead: false,
  },
  {
    country: 'China',
    status: '240-hour visa-free transit',
    cost: '$0',
    file: 'Onward ticket to a third country, printed',
    ahead: true,
  },
  {
    country: 'Thailand',
    status: 'Visa-free · 30 days',
    cost: '$0',
    file: 'TDAC arrival card, within 3 days of landing',
    ahead: true,
  },
  {
    country: 'Vietnam',
    status: 'E-visa · up to 90 days',
    cost: '~$25 pp',
    file: 'Official e-visa portal, ~2 weeks ahead',
    ahead: true,
  },
  {
    country: 'Indonesia',
    status: 'Visa on arrival · 30 days',
    cost: '~$32 pp + ~$10 levy',
    file: 'e-VOA, All Indonesia declaration, Bali levy',
    ahead: true,
  },
  {
    country: 'South Korea',
    status: 'Visa-free · 90 days',
    cost: '$0',
    file: 'e-Arrival card (K-ETA waived through 2026)',
    ahead: false,
  },
];
...
export const tigers = [
  {
    ...
    where: 'Bang Lamung, Chon Buri · ~1.5h drive from BKK',
    price: '900–1,800 THB',
    rating: '4.3 / 5 · 16,800+ reviews',
    desc: 'Supervised enclosure visits; price scales with the size of the animal. The only one reachable as a day trip from this route.',
  },
  {
    name: 'Tiger Kingdom Chiang Mai',
    where: 'Mae Rim, Chiang Mai · domestic flight from BKK',
    price: '750–3,000 THB',
    rating: '4.0 / 5 · 6,200+ reviews',
    desc: 'Newborn, smallest, small, medium and giant tiers — you pick which enclosure you enter.',
  },
  {
    name: 'Tiger Kingdom Phuket',
    where: 'Kathu, Phuket · domestic flight from BKK',
    price: '800–2,500 THB',
    rating: '3.9 / 5 · 15,500+ reviews',
    desc: 'Close contact and photos across age groups, including white tigers.',
  },
];
