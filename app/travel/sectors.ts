...
const sectorList: Sector[] = [
  {
    ...
    color: ASIA_RED,
    blurb:
      'Hawaiian flies the two nonstop doors, Tokyo and Seoul. Deeper in, JAL and Korean Air — both Alaska partners — carry the second leg.',
  ...
  },
  {
    ...
    slug: 'sa',
    label: 'South America',
    sector: 'Andean sector',
    blurb:
      'No nonstop exists. American’s Dallas hub is the door: one stop to Bogotá, Lima, Santiago, Buenos Aires and São Paulo, two to Rio.',
  ...
  },
  {
    ...
    slug: 'alaska',
    label: 'Alaska',
    sector: 'Arctic sector',
    blurb:
      'Nonstop only: Alaska Airlines’ summer seasonal to Anchorage, straight up the Pacific. Nothing else flies it direct.',
  ...
  },
  {
    ...
    color: DALLAS_BLUE,
    blurb:
      'American’s daily nonstop makes DFW the one-stop gateway to the East Coast, the Gulf, London and beyond.',
  ...
  },
  {
    ...
    blurb:
      'Two stops, all oneworld: a mainland gateway on Alaska or American, British Airways across the Atlantic, then the short hop from London.',
  ...
  },
  {
    ...
    slug: 'reykjavik',
    label: 'Reykjavik',
    sector: 'North Atlantic sector',
    blurb:
      'Icelandair is an Alaska partner. Seattle, New York and Boston put Keflavík one stop from Honolulu, and Europe one more.',
...
const routings: Leg[] = [
  // ── Asia ── Hawaiian nonstops, then JAL / Korean Air (Alaska Mileage Plan partners).
  {
    ...
    farePP: 200,
    time: 'Nonstop · ~8h',
    carriers: 'Hawaiian / Alaska · JAL (oneworld)',
    note: 'Hawaiian flies both Narita and Haneda. Visa-free 90 days in Japan.',
  },
  {
    n: '02',
    region: 'asia',
    ...
    farePP: 260,
    time: 'Nonstop · ~10.5h',
    carriers: 'Hawaiian / Alaska · Korean Air (Alaska partner)',
    note: 'The second door. Korean Air connects to all of Southeast Asia from here.',
  },
  {
    n: '03',
    region: 'asia',
    ...
    farePP: 340,
    time: '1 stop · ~14h',
    carriers: 'Hawaiian → JAL',
    note: 'One oneworld ticket. 240-hour visa-free transit in China — carry the onward ticket.',
    flag: 'visa',
  },
  {
    n: '04',
    ...
    time: '1 stop · ~17h',
    carriers: 'Hawaiian → JAL',
    note: 'Or via Seoul on Korean Air. Visa-free 30 days; file the TDAC arrival card.',
  },
  {
    n: '05',
    region: 'asia',
    ...
    time: '1 stop · ~17h',
    carriers: 'Hawaiian → JAL',
    note: 'JAL meets the Tokyo arrival bank with an evening Singapore departure.',
  },
  {
    n: '06',
    region: 'asia',
    ...
    farePP: 420,
    time: '1 stop · ~19h',
    carriers: 'Hawaiian → Korean Air',
    note: 'Visa on arrival, ~$32. Buy the e-VOA ahead of time.',
    flag: 'visa',
  },
  ...
  // ── South America ── American, one stop through its Dallas hub.
  {
    ...
    time: '1 stop · ~16h',
    carriers: 'American',
    note: 'American’s DFW–Lima nonstop. Lima is the door to Cusco.',
  },
  {
    n: '08',
    region: 'south-america',
    ...
    time: '1 stop · ~14h',
    carriers: 'American',
    note: 'Visa-free 90 days. Check-Mig form within 72h of arrival.',
  },
  {
    n: '09',
    region: 'south-america',
    ...
    time: '1 stop · ~18.5h',
    carriers: 'American',
    note: 'Overnight from Dallas. Santiago sits under the Andes wall — sit on the left.',
  },
  {
    n: '10',
    region: 'south-america',
    ...
    time: '1 stop · ~19h',
    carriers: 'American',
    note: 'American’s DFW–Buenos Aires nonstop. Overnight, land at dawn.',
  },
  {
    n: '11',
    region: 'south-america',
    ...
    time: '1 stop · ~18h',
    carriers: 'American',
    note: 'US passports need a Brazil e-visa since April 2025, ~$81.',
    flag: 'visa',
  },
  {
    n: '28',
    ...
    time: '2 stops · ~21h',
    carriers: 'American',
    note: 'American’s Rio flights leave from Miami, so it is Dallas then Miami then the overnight south. Same Brazil e-visa as São Paulo.',
    flag: 'visa',
  },
  ...
  // ── Alaska ── the one nonstop.
  {
    ...
    to: 'ANC',
    farePP: 260,
    time: 'Seasonal nonstop · ~6h',
    carriers: 'Alaska Airlines (summer)',
    note: 'Summer only — the one nonstop between Hawaiʻi and Alaska. Off-season it is a Seattle connection.',
    flag: 'win',
  },
  ...
  // ── Dallas ── American’s hub.
  {
    ...
    time: 'Nonstop · ~7.5h',
    carriers: 'American',
    note: 'Daily, year-round. The one nonstop into the middle of the map.',
  },
  {
    n: '14',
    region: 'dallas',
    ...
    time: '1 stop · ~12h',
    carriers: 'American',
    note: 'Or Hawaiian’s nonstop to JFK — compare. LaGuardia is closer to Manhattan, same fare.',
  },
  {
    n: '15',
    region: 'dallas',
    ...
    time: '1 stop · ~11.5h',
    carriers: 'American',
    note: 'The feeder for the Caribbean and every South America track.',
  },
  {
    n: '16',
    region: 'dallas',
    ...
    time: '1 stop · ~11h',
    carriers: 'American',
    note: 'Hub to hub. Winter weather is the variable.',
  },
  {
    n: '17',
    region: 'dallas',
    ...
    farePP: 620,
    time: '1 stop · ~18h',
    carriers: 'American · British Airways',
    note: 'One stop to London. Book the 787 or A350 on the Atlantic leg.',
    flag: 'win',
  },
  ...
  // ── Switzerland ── oneworld all the way: Alaska or American to the mainland, BA over the Atlantic and on to the Alps.
  {
    ...
    farePP: 720,
    time: '2 stops · ~21h',
    carriers: 'Alaska / Hawaiian → British Airways',
    note: 'BA’s LAX–London A380, then the 90-minute hop to Zurich. One ticket, bags checked through.',
  },
  {
    n: '19',
    region: 'switzerland',
    ...
    time: '2 stops · ~21h',
    carriers: 'American → British Airways',
    note: 'The American routing. Three BA departures a day from Dallas give the most flexible connection.',
  },
  {
    n: '20',
    region: 'switzerland',
    ...
    time: '2 stops · ~21.5h',
    carriers: 'American → British Airways',
    note: 'For the ski side. Ski-season Saturdays double the fare; fly midweek.',
  },
  {
    n: '21',
    region: 'switzerland',
    ...
    farePP: 740,
    time: '2 stops · ~22h',
    carriers: 'Alaska → British Airways',
    note: 'The northern routing — Seattle to London on BA, then Geneva.',
  },
  ...
  // ── Reykjavik ── Icelandair, an Alaska Mileage Plan partner.
  {
    ...
    farePP: 480,
    time: '1 stop · ~14h',
    carriers: 'Alaska → Icelandair',
    note: 'The shortest way. Icelandair’s Seattle flight leaves in the afternoon.',
    flag: 'win',
  },
  {
    n: '23',
    ...
    farePP: 520,
    time: '1 stop · ~16h',
    carriers: 'Hawaiian → Icelandair',
    note: 'Hawaiian’s nonstop to JFK meets Icelandair’s evening departure.',
  },
  {
    n: '24',
    region: 'reykjavik',
    ...
    time: '1 stop · ~15.5h',
    carriers: 'Hawaiian → Icelandair',
    note: 'Boston is the shortest Atlantic crossing from the US.',
  },
  {
    n: '25',
    region: 'reykjavik',
    ...
    time: '2 stops · ~19h',
    carriers: 'Alaska → Icelandair',
    note: 'The free stopover: up to seven days in Iceland at no fare penalty, then on to London.',
  },
  {
    n: '26',
    region: 'reykjavik',
    ...
    time: '2 stops · ~20h',
    carriers: 'Hawaiian → Icelandair',
    note: 'Into Scandinavia. Schengen entry at Keflavík.',
  },
  {
    n: '27',
    region: 'reykjavik',
    ...
    time: '2 stops · ~21h',
    carriers: 'Hawaiian → Icelandair',
    note: 'Paris by the northern route — often cheaper than a direct Atlantic crossing.',
  },
];
...
export const sectorNonstop = (key: string) =>
  routings.some((l) => l.region === key && stops(l) === 0);
...
export const travelPages: TravelPage[] = [
  ...
  })),
  {
    ...
    blurb:
      'Honolulu to Rio on one American ticket: Dallas, then Miami, then the overnight south. The Brazil e-visa is the only paperwork.',
...
export const travelSlugs = travelPages
  .filter((p) => !p.static)
  .flatMap((p) => [p.slug, ...(p.aliases ?? [])]);
