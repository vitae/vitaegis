    ...
    >
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ fontSize: 9, letterSpacing: 8, color: '#00ff9d44', marginBottom: 8 }}>
            VITAEGIS · ADMIN
          </div>
          <h1
            style={{
        ...
        {/* Tabs */}
        <div
          style={{ display: 'flex', gap: 2, marginBottom: 28, borderBottom: '1px solid #00ff9d1a' }}
        >
          {(
            [
              ['single', '+ SINGLE QUOTE'],
        ...
        {tab === 'single' && (
          ...
          >
            <div style={{ fontSize: 10, letterSpacing: 4, color: '#00ff9d55', marginBottom: 20 }}>
              NEW ENTRY
            </div>
            <textarea
              value={form.text}
            ...
            >
              ...
              {pdfFile ? (
                <div>
                  ...
                  <div style={{ fontSize: 13, color: '#00ff9d', letterSpacing: 2 }}>
                    {pdfFile.name}
                  </div>
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 13, color: '#00ff9d66', letterSpacing: 2, marginBottom: 6 }}
                  >
                    DROP PDF HERE OR CLICK TO BROWSE
                  </div>
                  <div style={{ fontSize: 10, color: '#00ff9d33', letterSpacing: 1 }}>
                    Books, guides, scriptures, manuscripts
                  </div>
                </div>
              )}
            </div>
              ...
              <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
                ...
                <select
                  ...
                  style={{
                    background: '#000',
                    border: '1px solid #00ff9d22',
                    color: TAG_COLORS[pdfTag] || '#00ff9d',
                    padding: '10px 14px',
                    fontSize: 11,
                    fontFamily: 'inherit',
                    outline: 'none',
              ...
              <div>
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button
                      onClick={() =>
                        setExtractedQuotes((q) => q.map((x) => ({ ...x, selected: true })))
                      }
                      style={{
                    ...
                    <button
                      onClick={() =>
                        setExtractedQuotes((q) => q.map((x) => ({ ...x, selected: false })))
                      }
                      style={{
                        background: 'transparent',
                    ...
                    >
                      <div
                        style={{
                          width: 15,
                          height: 15,
                          border: `1px solid ${q.selected ? '#a78bfa' : '#00ff9d22'}`,
                          background: q.selected ? '#a78bfa22' : 'transparent',
                          flexShrink: 0,
                          marginTop: 2,
                          display: 'flex',
                          alignItems: 'center',
                      ...
                      <div style={{ flex: 1 }}>
                        <div
                          style={{
                            fontSize: 13,
                            color: q.selected ? '#d0ffd8' : '#d0ffd855',
                            lineHeight: 1.6,
                            marginBottom: 4,
                          }}
                        >
                        ...
                        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                          ...
                          <span
                            style={{
                              ...
                              letterSpacing: 2,
                              padding: '1px 6px',
                              border: `1px solid ${TAG_COLORS[q.tag] || '#00ff9d'}33`,
                              color: TAG_COLORS[q.tag] || '#00ff9d',
                            }}
                          >
                            {q.tag}
                          </span>
                ...
                >
                  {bulkDone
                    ? `✓ ${selectedCount} QUOTES ENCODED`
                    : encodingBulk
                      ? 'ENCODING...'
                      : `+ ENCODE ${selectedCount} SELECTED INTO ARCHIVE`}
                </button>
              </div>
            )}
          </div>
        ...
        <div>
          ...
          {proverbs.map((p) => (
            ...
            >
              ...
              />
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, color: '#d0ffd8', lineHeight: 1.6, marginBottom: 5 }}>
                  &quot;{p.text}&quot;
                </div>
                <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <span style={{ fontSize: 9, color: '#00ff9d22', letterSpacing: 1 }}>
                    {new Date(p.created_at).toLocaleDateString()}
                  </span>
                </div>
                {p.note && (
                  <div
                    style={{ fontSize: 11, color: '#00ff9d2a', marginTop: 5, fontStyle: 'italic' }}
                  >
                    ↳ {p.note}
                  </div>
                )}
